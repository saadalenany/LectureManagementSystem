...
public class slides {
    ...
    int slide_id, numberofwatechers, doctor_id;
    ...
    public slides(int slide_id, String slide_name, String slide_path, String slide_course, int numberofwatechers, int doctor_id) {
        this.slide_id = slide_id;
        this.numberofwatechers = numberofwatechers;
        this.slide_name = slide_name;
        this.slide_path = slide_path;
